            ...
            <div class="header-content">
                ...
                <nav>
                    ...
                    <ul :class="{open: isMenuOpen}">
                        ...
                        <li>
                            <router-link :class="{ active: isActiveRoute('/') }" to="/" @click.prevent="scrollToSection('main')">Записаться</router-link>
                        </li>
                        <li>
                            <router-link :class="{ active: isActiveRoute('/#price') }" to="/#price" @click.prevent="scrollToSection('price')">Цены</router-link>
                        </li>
                        <li>
                            <router-link :class="{ active: isActiveRoute('/#contacs') }" to="/#contacs" @click.prevent="scrollToSection('contacs')">Контакты</router-link>
                        </li>
                        <li>
...
<style>
    ...
    .header-content ul a.active, a:hover {
        color: #EE1C43;
        transition: 0.5s;
    }
